...
- Search names use Unicode NFKC normalization, trimmed/collapsed whitespace, and locale-independent English lowercase. PostgreSQL trigram indexes operate on the stored result.
